...
import { addCategory, AddFaq, AddNotifications, AddRegions, ListCategories, TestCats } from "../../Services/Api";
...
const AddRegion = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await AddRegions(auth_key, user_id, EmirateEN, EmirateAr, RegionEn, RegionAr , ShipingCost);   
